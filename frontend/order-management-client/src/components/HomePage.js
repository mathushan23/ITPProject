            ...
            <div className="collapse navbar-collapse justify-content-center">
              <ul className="navbar-nav">
                <li className="nav-item">
                  <Link className="nav-link text-white" to="/ddd">
                    Home
                  </Link>
                </li>
                <li className="nav-item">
                ...
                <li className="nav-item">
                  <Link className="nav-link text-white" to="/usehyvy">
                    Inventory
                  </Link>
                </li>
                <li className="nav-item">
...
<br/>
        ...
        <Container>
          <h1 class="homepagewelcome">Welcome to the Order Management System</h1>
